...
class Data:
    ...
    def split(self, orig_trajs, samp_trajs, labels, train_split=0.6, val_split=0.2):
        ...
        train_int = int(train_split * orig_trajs.shape[0])  # X% of the data length for training
        val_int = int((train_split + val_split) * orig_trajs.shape[0])  # X% more for validation
